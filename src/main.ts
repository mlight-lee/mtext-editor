...
void tinymce.init({
  ...
  toolbar:
    "undo redo | forecolor | bold italic underline strikethrough overline subscript superscript | alignleft aligncenter alignright | bullist numlist | code | letterspacing letterwidth",
  menubar: false,
  skin: false,
  content_css: false,
  license_key: "gpl",
